 ...
 * 
 * This object allows the SHA-512 hashing of strings with the addition of a randomly generated salt string. Each time the object is created,
 * a new string is generated, so there are methods allows the use of a predetermined salt string to check for matching hashes when a user logs in
 * 
 */
...
public class SaltedSHA512 {
	...
	public SaltedSHA512(String plaintext1)
	{
